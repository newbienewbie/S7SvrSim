...
namespace S7SvrSim.UserControls.Signals.SetBox
{
    ...
    public class RealSignalSetBox : Control, IViewFor<RealSignalSetBoxVM>
    {
        private TextBox PART_ValueBox;

        public RealSignalSetBox()
        {
        ...
        public static readonly DependencyProperty ViewModelProperty =
            DependencyProperty.Register("ViewModel", typeof(RealSignalSetBoxVM), typeof(RealSignalSetBox), new PropertyMetadata(null, OnViewModelChanged));
